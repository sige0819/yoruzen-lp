...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      {
        q: "ヒロットとは何ですか？",
        a: "フィリピンに伝わる伝統的な手技療法です。温かい手のひらと植物オイルを使い、深いリラックスへ導く穏やかな手技です。一般的な強い揉みほぐしや指圧とは異なります。",
      },
      {
        q: "オイルを使うと髪や服が汚れませんか？",
        a: "ヒロット用の低残留性植物オイルを使用し、施術後はホットタオルで丁寧に拭き取ります。シャワー設備もご用意しています。終わった後そのままお出かけいただくことも可能です（着替えは推奨）。",
      },
      {
        q: "着替えは必要ですか？",
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "荷物は持ち込めますか？",
        a: "小さな手荷物はお持ちいただけます。大型荷物の預かりは行っておりませんので、近隣のコインロッカー等をご利用ください。",
      },
    ],
  },
];
...
export default function JpFaqPage() {
  ...
  useEffect(() => {
    document.title = "よくある質問｜ヒロット専門 yoru+禅 鹿児島中央駅";
