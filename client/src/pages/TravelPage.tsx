...
// Round 4: Travel = Square only (no LINE) — inbound = online booking only
    ...
    <div className="min-h-screen bg-[#1A1F2E] text-[#EDE8DC]">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-end overflow-hidden">
        ...
        >
          ...
          {/* CTA — Top (Square only — inbound = online booking only) */}
      ...
      >
        ...
        <div className="relative z-10 container">
          ...
          {/* CTA — Middle (Square only — inbound = online booking only) */}
          <AnimatedSection>
      ...
      >
        ...
        <div className="relative z-10 container">
          <AnimatedSection>
            ...
            {/* CTA — Square only (inbound = online booking only) */}
            <div className="flex flex-col items-center gap-3">
              <CTAButton href={SQUARE_TRAVEL_URL} sub="Hilot 90 min — ¥18,000">
                Book Now
              </CTAButton>
